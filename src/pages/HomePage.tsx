...
const smartWatchesData: IProducts[] = [
...
const motherboardsData: IProducts[] = [
...
const headphonesData: IProducts[] = [
...
const microphonesData: IProducts[] = [
